Doorkeeper.configure do
  ...
  default_scopes  'user'
  optional_scopes 'resources', 'resources-read', 'devices', 'devices-control', 'devices-read', 'consumptions', 'consumptions-read', 'histories-read', 'types', 'types-read', 'locations', 'locations-read', 'privates'
