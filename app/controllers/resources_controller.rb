class ResourcesController < Doorkeeper::ApplicationController
  ...
  def find_resources
    ...
    @locations = Location.where(resource_owner_id: current_resource_owner.id)
  end
  ...
  def find_params
    @params = { response_type: params[:response_type],
